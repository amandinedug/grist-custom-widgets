...
- 🎨 **10 couleurs** — Palette avec prévisualisation en direct dans le panneau de configuration.
...
2. Collez l'URL : `https://amandinedug.github.io/grist-custom-widgets/FR/compteur-lignes/`
3. Définissez le niveau d'accès sur **Read table**
4. Liez le widget à la table dont vous souhaitez compter les lignes

### Option 2 dégradée : Installation manuelle
⚠️ _en utilisant cette option, vous n'aurez pas accès au panneau de configuration pour modifier le label ou la couleur._
...
Cliquez sur l'icône ••• du widget pour ouvrir le panneau de configuration :
